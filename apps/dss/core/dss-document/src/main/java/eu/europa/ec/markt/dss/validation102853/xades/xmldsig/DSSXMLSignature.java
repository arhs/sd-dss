 ...
 * signature. </li></ul>
 */
public final class DSSXMLSignature extends SignatureElementProxy {
    ...
    private static org.slf4j.Logger log =
        org.slf4j.LoggerFactory.getLogger(DSSXMLSignature.class);
    
    /** ds:Signature.ds:SignedInfo element */
    private DSSSignedInfo signedInfo;
     ...
     */
    public DSSXMLSignature(Document doc, String baseURI, String signatureMethodURI)
        throws XMLSecurityException {
    ...
    public DSSXMLSignature(
        ...
        this.baseURI = baseURI;
        this.signedInfo = 
            new DSSSignedInfo(getDocument(), SignatureMethodElem, CanonicalizationMethodElem);
     ...
     */
    public DSSXMLSignature(Element element, String baseURI)
     ...
     * @throws XMLSignatureException if the signature is badly formatted
     */
    public DSSXMLSignature(Element element, String baseURI, boolean secureValidation)
        throws XMLSignatureException, XMLSecurityException {
        ...
        this.signedInfo = new DSSSignedInfo(signedInfoElem, baseURI, secureValidation);
    ...
    public void sign(Key signingKey) throws XMLSignatureException {
        ...
        try {
            ...
            DSSSignedInfo si = this.signedInfo;
