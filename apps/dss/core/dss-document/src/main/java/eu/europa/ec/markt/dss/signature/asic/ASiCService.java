...
public class ASiCService extends AbstractSignatureService {
  ...
  private DSSDocument copyDetachedContent(final SignatureParameters underlyingParameters,
  ...
  private InMemoryDocument createASiCContainer(final ASiCParameters asicParameters,
                                               final ByteArrayOutputStream outBytes, final String toSignDocumentName) {
