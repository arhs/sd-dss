...
public enum SignatureLevel {
	...
	XML_NOT_ETSI(null), XAdES_BASELINE_B(XML_NOT_ETSI), XAdES_BASELINE_T(XAdES_BASELINE_B), XAdES_BASELINE_LT(XAdES_BASELINE_T), XAdES_BASELINE_LTA(XAdES_BASELINE_LT), XAdES_C(
		  XAdES_BASELINE_T), XAdES_X(XAdES_C), XAdES_XL(XAdES_X), XAdES_A(XAdES_XL),

	CMS_NOT_ETSI(null), CAdES_BASELINE_B(CMS_NOT_ETSI), CAdES_BASELINE_T(CAdES_BASELINE_B), CAdES_BASELINE_LT(CAdES_BASELINE_T), CAdES_BASELINE_LTA(
		  CAdES_BASELINE_LT), CAdES_101733_C(CAdES_BASELINE_T), CAdES_101733_X(CAdES_101733_C), CAdES_101733_XL(CAdES_101733_X), CAdES_101733_A(CAdES_101733_XL),

	PDF_NOT_ETSI(null), PAdES_BASELINE_B(PDF_NOT_ETSI), PAdES_BASELINE_T(PAdES_BASELINE_B), PAdES_BASELINE_LT(PAdES_BASELINE_T), PAdES_BASELINE_LTA(
		  PAdES_BASELINE_LT), PAdES_102778_LTV(PAdES_BASELINE_B),
