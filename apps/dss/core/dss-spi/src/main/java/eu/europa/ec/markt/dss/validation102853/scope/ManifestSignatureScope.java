 ...
 *
 */
public class ManifestSignatureScope extends SignatureScope {

	private final List<String> transformations;

	protected ManifestSignatureScope(String xmlId, final List<String> transformations) {
		super(xmlId);
	...
	public String getDescription() {
		...
		String description = "The 'manifest' referenced by the element with ID '" + getName() + "'";
