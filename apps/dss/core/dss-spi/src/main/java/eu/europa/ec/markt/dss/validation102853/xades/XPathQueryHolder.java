...
public class XPathQueryHolder implements Serializable {
	...
	public String XPATH_DATA_OBJECT_FORMAT = XPATH_SIGNED_DATA_OBJECT_PROPERTIES + "/xades:DataObjectFormat";
	public String XPATH_DATA_OBJECT_FORMAT_MIME_TYPE = XPATH_DATA_OBJECT_FORMAT + "/xades:MimeType";
	...
	public String XPATH_COUNT_DATA_OBJECT_FORMAT_MIME_TYPE = "count(" + XPATH_DATA_OBJECT_FORMAT_MIME_TYPE + ")";
