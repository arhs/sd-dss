...
/**
 * This class hold all XPath queries schema-dependent. It was created to cope with old signatures bases on http://uri
 * .etsi.org/01903/v1.1.1.
 * <p/>
...
public class XPathQueryHolder implements Serializable {
  ...
  /**
   * This query is used to determinate {@code XPathQueryHolder} tu use if function of the namespace of
   * QualifyingProperties.
   * public final String XPATH_QUALIFYING_PROPERTIES_NAMESPACE = "namespace-uri(./ds:Signature/ds:Object/*[local-name
   * ()='QualifyingProperties'])";
   * This is not used anymore. See
   */

  public String XPATH__QUALIFYING_PROPERTIES_SIGNED_PROPERTIES = XPATH__QUALIFYING_PROPERTIES +
  ...
  public String XPATH_ALL_DATA_OBJECTS_TIMESTAMP = XPATH_SIGNED_DATA_OBJECT_PROPERTIES + "/" +
      XPATH__ALL_DATA_OBJECTS_TIMESTAMP;
  public String XPATH_INDIVIDUAL_DATA_OBJECTS_TIMESTAMP = XPATH_SIGNED_DATA_OBJECT_PROPERTIES + "/" +
  ...
  public String XPATH_SIGNING_CERTIFICATE_CERT = XPATH_SIGNED_SIGNATURE_PROPERTIES +
      "/xades:SigningCertificate/xades:Cert";
  public String XPATH_CERT_DIGEST = XPATH_SIGNING_CERTIFICATE_CERT + "/xades:CertDigest";
  public String XPATH_SIGNATURE_POLICY_IDENTIFIER = XPATH_SIGNED_SIGNATURE_PROPERTIES +
      "/xades:SignaturePolicyIdentifier";
  public String XPATH_CLAIMED_ROLE = XPATH_SIGNED_SIGNATURE_PROPERTIES +
  ...
  public String XPATH_COMPLETE_CERTIFICATE_REFS = XPATH_UNSIGNED_SIGNATURE_PROPERTIES +
  ...
  public String XPATH_TIME_STAMP_VALIDATION_DATA = XPATH_UNSIGNED_SIGNATURE_PROPERTIES +
  ...
  public String XPATH_ARCHIVE_TIMESTAMP_141 = XPATH_UNSIGNED_SIGNATURE_PROPERTIES + "/xades141:" +
      XMLE_ARCHIVE_TIME_STAMP;
  public String XPATH_ARCHIVE_TIMESTAMP_V2 = XPATH_UNSIGNED_SIGNATURE_PROPERTIES + "/xades141:" +
