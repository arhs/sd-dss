...
/**
 * This class is a container for all reports generated by the validation process: diagnostic data,
 * detailed report and simple report.
 * <p/>
...
public class Reports {
  ...
  /**
   * This variable defines the sequence of the reports related to a document to validate. It's only used with ASiC-E
   * container.
   */
  ...
  /**
   * This method allows to set the sequence of the reports related to a document to validate. It's only used with
   * ASiC-E container.
   *
   * @param nextReports
   */
  ...
  /**
   * @return {@code Reports} which corresponds to the next signature found with in the ASiC-E container. {@code null}
   * if there is no more signatures.
   */
